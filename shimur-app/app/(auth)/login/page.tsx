...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: '#F7F0E3' }}>
      <div className="w-full max-w-md rounded-lg shadow-lg p-8" style={{ backgroundColor: 'white', borderTop: '4px solid #C8B89A' }}>
        <h1 className="text-3xl font-serif font-bold mb-2 text-center" style={{ color: '#1A1410' }}>
          SHIMUR.ASHDOD
        </h1>
        <p className="text-center text-sm mb-8" style={{ color: '#3D3228' }}>
          מערכת ניהול מורשת בנויה
        </p>

        <LoginFormImpl />

        <div className="mt-8 pt-6" style={{ borderTop: '1px solid #EDE0CC' }}>
          <p className="text-xs text-center" style={{ color: '#3D3228' }}>
            גרסה 2.0 | מבוסס על תיקי תיעוד אמיתיים
          </p>
        </div>
      </div>
    </div>
